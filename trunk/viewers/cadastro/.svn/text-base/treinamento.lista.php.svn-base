...
<?php
	$Item = new Treinamento; //instancia Treinamento
	...
	if(empty($Item)){
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
                ...
                ?>
                <tr>
                  <td><?php echo $itemRow['nome_treinamento']; ?></td>
                  <td><?php echo $itemRow['topicos_treinamento']; ?></td>
                  <td><?php echo $itemRow['cargahoraria_treinamento']; ?></td>
                  <td class="text-center EditarItem" id="<?php echo $itemRow['id_treinamento']; ?>">
                  	<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                  </td>
                  <td class="text-center ExcluirItem" id="<?php echo $itemRow['id_treinamento']; ?>">
