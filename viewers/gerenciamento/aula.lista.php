	...
	if(empty($Item)){
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
                ...
                ?>
                <tr>
                  <td><?php echo $itemRow['sala_aula']; ?></td>
                  <td><?php echo $itemRow['predio_aula']; ?></td>
                  <td><?php echo $itemRow['campus_aula']; ?></td>
                  <td><?php echo $itemRow['dt_aula']; ?></td>
				  <td><?php echo $itemRow['hr_aula']; ?></td>
                  <td class="text-center EditarItem" id="<?php echo $itemRow['id_aula']; ?>">
                  	<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                  </td>
                  <td class="text-center ExcluirItem" id="<?php echo $itemRow['id_aula']; ?>">
