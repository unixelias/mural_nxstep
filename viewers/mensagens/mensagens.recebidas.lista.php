...
<?php
	...
	$Mensagem = $Mensagem->ReadUserRec_JointInfo($user['id_usuario']); //lê todos os registros no BD
	...
	if(empty($Mensagem)){
		...
		?>
        <h2 class="well" align="center" role="heading">Mensagens pessoais de <?php echo $user['nome_usuario']; ?></h2>
		...
		<div class="cd-timeline-block">
			...
			<div class="cd-timeline-content">
				<h2>De: <?php echo $itemRow['nome_usuario']; ?></h2>
